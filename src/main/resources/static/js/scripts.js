...
$(document).ready(function() {
    $('.delete-book').on('click', function (){
        ...
        bootbox.confirm({
            message: "Are you sure that you want  to remove this book? It can't be undone.",
            buttons: {
                cancel: {
    ...
    $('#deleteSelected').click(function() {
        ...
        bootbox.confirm({
            message: "Are you sure that you want to remove all selected books? It can't be undone.",
            buttons: {
                cancel: {
                    label:'<i class="fa fa-times"></i> Cancel'
                },
